...
const char * const DIGIBYTE_CONF_FILENAME = "ega.conf";
const char * const DIGIBYTE_PID_FILENAME = "egad.pid";
...
{
    // Windows: %APPDATA%\EGA
    // Mac: ~/Library/Application Support/EGA
    // Unix: ~/.ega
#ifdef WIN32
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EGA";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    return pathRet / "Library/Application Support/EGA";
#else
    return pathRet / ".ega";
#endif
#endif
